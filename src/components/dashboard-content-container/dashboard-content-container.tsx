...
export default function RepoDashboardContentContainer() {
    ...
    const fetchStats = async (ac: any) => {
        try {
            ...
            if (!selectedContributor) window.location.href = '/dashboard';

            const url = `${API_BASE}${DASHBOARD_BASE}/repository/${selectedRepo!.full_name}/contributors/${selectedContributor!.node_id}`;
